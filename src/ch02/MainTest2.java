...
public class MainTest2 {
	...
	public static void main(String[] args) {
		...
		// 사용하는 시점에 T 대신 어떤 자료형을 사용할지 지정 하면된다
		GenericPrinter<Plastic> genericPrinter1 = new GenericPrinter<>();
		Plastic returnplastic = genericPrinter1.getMaterial(); // 메서드 의존 주입

		// 최상위 Object 를 활용할떄와 비교
		// 형변환 할 필요가 없다 (다운 캐스트)
...
//		Powder returnPowder = genericPrinter1.getMaterial(); < -- 오류 발생
		...
		// 제네릭 프로그래밍에 단점
		// 사용하는 시점에 무엇이든 담을 수 있기 때문에 클래스 설계자 입장으로 바라 볼때
